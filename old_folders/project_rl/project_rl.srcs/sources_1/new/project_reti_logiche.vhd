...
architecture rtl of project_reti_logiche is
    ...
    signal TOT_PIXEL, K , TOT_PIXEL_ORIGINAL: integer; -- totale di pixel da salvare/valutare (al massimo 16384 pixel = 128*128)
    ...
    begin
        ...
        begin
            ...
            if rising_edge(i_clk) and synced = '0' then
                J <= COUNTER;
                K <= TOT_PIXEL;
                synced <= '1';
            end if; 
